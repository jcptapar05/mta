  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button className="w-full focus-visible:ring-offset-0 bg-white hover:bg-gray-200 text-black py-8 focus-visible:ring-0 border text-md">
          My Account
        </Button>
      </SheetTrigger>
      <SheetContent className="bg-[#F8F8F8]">
        <ScrollArea className="h-screen">
          <div className="pt-8 md:ps-8 appdrawer">
            {drawerItem.map((item) => (
              <div key={item.name}>
                {item?.children && (
                  // with dropdown
...
export default AdminDrawerMobile;

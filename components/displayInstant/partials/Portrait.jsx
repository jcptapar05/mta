...
const Portrait = () => {
 ...
 return (
  <div className="flex justify-center items-center relative">
   <img
    src="./frames/framesample.png"
    alt=""
    className="w-[100%] mx-auto relative max-w-[500px]"
   />
    ...
    <div className="relative">
     ...
     {file && (
      <img
       src={file}
       alt="Preview Image"
       className="absolute top-0 left-0 z-[-1] h-screen w-screen max-h-[400px] max-w-[540px] object-cover"
      />
     )}

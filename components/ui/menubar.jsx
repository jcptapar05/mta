...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
	<MenubarPrimitive.Trigger
		ref={ref}
		className={cn(
			'flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-sm outline-none hover:bg-slate-800 hover:text-white focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-slate-800 data-[state=open]:text-white',
			className
		)}
		{...props}
	/>

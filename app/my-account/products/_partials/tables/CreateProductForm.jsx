...
const CreateProductForm = ({
  ...
  const [isSetOf, setIsSetOf] = useState(1);
  ...
  const submit = async (e) => {
    ...
    if (res.ok && dataRes.message == "Success") {
        ...
        <DialogContent className="max-w-[900px]">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-6 w-full mb-5">
              ...
              {/* <div className="flex flex-col space-y-1.5">
                <Label>Enter Art Weight (kgs)</Label>
                <Input
              ...
              <div className="flex flex-col space-y-1.5">
                <Label htmlFor="uploadProductImg">
                  Wall Art Mockup or NFT Image (Art work with background)
                </Label>
                <Input
                  id="uploadProductImg"
                  type="file"
            ...
            <div className="text-end">
              ...
              {!isUploading && <Button className="px-20">Create</Button>}
              {isUploading && (

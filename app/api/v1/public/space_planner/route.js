...
import SpacePlannerMailTemplate from '@/emails/SpacePlannerMailTemplate';
...
export const POST = async (req, res) => {
  ...
  try {
    ...
    if (productPhotos.length > 0) {
      ...
      const emailHtml = render(SpacePlannerMailTemplate({ email: email, details }))

      const textFormat = `Hi ,
  
      Mind pinpointing spots for art at the event? Your creative touch is key!
      ...
      var mailOptions = {
        ...
        subject: 'My Top Arts | Space Planner',

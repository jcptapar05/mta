...
const Showroom = () => {
  ...
  useEffect(() => {
    function getShowroomParms() {
      if (params.id == "my_top_arts") {
        setShowroomLink("https://vr.1clickdesign.com/my_top_arts/#autoplay");
      }

      if (params.id == "gallery") {
        setShowroomLink("https://vr.1clickdesign.com/mta/#autoplay");
      }

      if (params.id == "lobby_and_hallways") {
        setShowroomLink("https://vr.1clickdesign.com/mta_hallways/#autoplay");

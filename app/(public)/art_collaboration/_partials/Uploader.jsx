...
const Uploader = () => {
  ...
  const submit = async (e) => {
    ...
    const res = await fetch(getURL("/api/v1/public/art_collaboration"), {
      method: "POST",
      body: formData,
    });
      ...
      {session ? (
        <Dialog>
          <DialogTrigger asChild>
            ...
            >
              Upload image <BsUpload className="h-10 ms-6" />
            </Button>
          </DialogTrigger>
          <DialogContent className="sm:max-w-[580px] pt-20">
            ...
            <p>Please tell us additional details about the image</p>
            <Textarea
              value={details}

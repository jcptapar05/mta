...
export default function SendMailToAdmin({ orderId, first_name, message }) {
  return (
    <Html lang="en">
      <Section style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Thank you for your recent order with MTA. We'll get back to you with
            any assistance you may need regarding order {orderId}.
          </Text>
